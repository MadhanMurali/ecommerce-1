...
const OrderCardFinished = ({show_buttons}) => {
        ...
        <div className="row card-panel">
            <div className="col s12 m12 l12">
                <div className="row valign-wrapper order-card">
                    <div className="col s12 m12 l6">
                        <div className="order-card-product-flex-container">
                            <div className="order-card-product-img-div">
                                <img alt="product" src={ProductImage8}/>
                            </div>
                    ...
                    <div className="col s12 m12 l6">
                        <p className="left-align order-card-product-address">Shipping to {address}</p>
                        <p className="left-align order-card-product-order-no">Order #: {orderNumber}</p>
                        <p className="left-align order-card-product-order-status">Status: {status2}</p>
                    </div>
                </div>

                {
                    (show_buttons)
                        ?   <div className="order-card-product-options center-align">
                                ...
                                <AnchorButton 
                                    href={`${url}/track-order`} title="Track Order"
                                    using_router={true}
                                    other_classes={"black-text btn-flat"} icon_name={""}/>
                            </div>
                        :   <></>
...
export default OrderCardFinished;